...
template PaypalActorEmailExtraction(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[0][i].in[18] <== eq[17][i].out;
		multi_or[0][i].in[19] <== eq[18][i].out;
		multi_or[0][i].in[20] <== eq[19][i].out;
		multi_or[0][i].in[21] <== eq[20][i].out;
		multi_or[0][i].in[22] <== eq[21][i].out;
		multi_or[0][i].in[23] <== eq[22][i].out;
		multi_or[0][i].in[24] <== eq[23][i].out;
		multi_or[0][i].in[25] <== eq[24][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i] <== MultiOR(5)([states[i+1][1] * states[i+2][2], states[i+1][2] * states[i+2][2], states[i+1][2] * states[i+2][3], states[i+1][3] * states[i+2][4], states[i+1][4] * states[i+2][4]]);
